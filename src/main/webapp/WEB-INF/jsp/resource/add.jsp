			  ...
			  <div class="panel-body">
				<form role="form">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="resourceName" placeholder="请输入资源名称">
					</div>
					<div class="form-group">
						<label for="resourceUrl">资源路径</label>
						<input type="text" class="form-control" id="resourceUrl" placeholder="请输入资源路径">
					</div>
					<div class="form-group" >
						<label >资源类型</label>
