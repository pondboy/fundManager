        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="panel panel-default">
			  <div class="panel-heading">
				<h3 class="panel-title"><i class="glyphicon glyphicon-th"></i> 数据列表 -- 激进型基金配置</h3>
			  </div>
...
<button type="button" class="btn btn-primary" style="float:right;" onclick="addFund('radical')"><i class="glyphicon glyphicon-plus"></i> 新增</button>
<br>
 <hr style="clear:both;">
            			...
            			if ( result.success ) {
            				...
            				$.each(fundSteadys, function(i, fundSteady){
								...
								tableContent += '  <td>'+fundSteady.investmentRation+'</td>';
	          	                tableContent += '  <td>';
								tableContent += '  <button type="button" onclick="goUpdatePage('+fundSteady.id+')" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></button>';
