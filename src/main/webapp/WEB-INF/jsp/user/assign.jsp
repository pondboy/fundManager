        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#left2RightBtn").click(function(){
					var userId = ${user.id};
					var roleIds = [];
					$("#leftList :selected").each(function (i) {
						roleIds[i] = $(this).val();
					})
			    	if ( roleIds.length == 0 ) {
			    		...
			    		$.ajax({
			    			...
			    			success : function(result) {
			    				if ( result.success ) {
			    					$("#rightList").append($("#leftList :selected"));
			    ...
			    $("#right2LeftBtn").click(function(){
					var userId = ${user.id};
					var roleIds = [];
					$("#rightList :selected").each(function (i) {
						roleIds[i] = $(this).val();
					})
					if ( roleIds.length == 0 ) {
			    		...
			    		$.ajax({
			    			...
			    			success : function(result) {
			    				if ( result.success ) {
			    					$("#leftList").append($("#rightList :selected"));
