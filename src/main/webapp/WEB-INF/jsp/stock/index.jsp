					...
					<li class="list-group-item">
						...
						<ul style="margin-top:10px;">
							<li style="height:30px;">
								<a href="${APP_PATH}/fund/steady" style="color:red;"><i class="glyphicon glyphicon-user"></i> 稳健型基金配置 </a>
							</li>
							<li style="height:30px;">
								<a href="${APP_PATH}/fund/radical"><i class="glyphicon glyphicon-king"></i> 激进型基金配置 </a>
							</li>
							<li style="height:30px;">
								<a href="${APP_PATH}/fund/option"><i class="glyphicon glyphicon-lock"></i> 自选基金池 </a>
							</li>
						</ul>
					</li>
					<li class="list-group-item tree-closed">
						...
						<ul style="margin-top:10px;display:none;">
							<li style="height:30px;">
								<a href="${APP_PATH}/stock/hold"><i class="glyphicon glyphicon-check"></i> 持有股票池 </a>
							</li>
							<li style="height:30px;">
								<a href="${APP_PATH}/stock/option"><i class="glyphicon glyphicon-check"></i> 自选股票池 </a>
							</li>
							<li style="height:30px;">
								<a href="${APP_PATH}/stock/strategy"><i class="glyphicon glyphicon-check"></i> 明日操作策略 </a>
							</li>
						</ul>
					</li>
				</ul>
